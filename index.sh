...
center_text "${GREEN}7. passwordrandom.com${RESET} - パスワード生成"
center_text "${GREEN}8. official-joke-api${RESET} - ジョークAPI"
center_text "${GREEN}9. hastebin.com${RESET} - テキスト共有サービス"
center_text "${GREEN}10. networkcalc.com${RESET} - 数値変換API"
echo
